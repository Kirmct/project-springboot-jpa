...
public class TestConfig implements CommandLineRunner {//tudo sera executado quando app iniciada
    ...
    public void run(String... args) throws Exception {
        ...
        //para instanciar a nova tabela de associacao temos que adicionar
        ...
        //depois de adicionar temos que inserir novamente
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
        ...
        o1.setPayment(pay1);
        //nao precisamos de repository no pagamento
        //pois no jpa funciona assim, salva o pagamento junto ao pedido
